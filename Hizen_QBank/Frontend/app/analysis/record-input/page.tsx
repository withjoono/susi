...
import { Plus, Minus, Upload, FileText, ExternalLink } from "lucide-react"
...
export default function RecordInputPage() {
  ...
  const [selectedGradeForUpload, setSelectedGradeForUpload] = useState<string>("")
  ...
  const handleFileUpload = () => {
    if (selectedFile && selectedGradeForUpload) {
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-4">
                <Select value={selectedGradeForUpload} onValueChange={setSelectedGradeForUpload}>
                ...
                <label htmlFor="file-input">
                  <Button
                    ...
                    disabled={!selectedGradeForUpload}
                  >
              ...
              <Button
                ...
                disabled={!selectedFile || !selectedGradeForUpload}
                ...
                <div className="space-y-2">
                  {uploadedFiles.map((file, index) => (
                    <div key={index} className="flex items-center space-x-2 text-sm text-gray-700">
                      ...
                      <span>{file.name}</span>
                      <span className="text-blue-600 text-xs">({selectedGradeForUpload})</span>
                    </div>
                  ))}
                </div>
              )}
